...
# Date Edited: 4-16-20
# Desc: This will run functions for mainIsland
#--------------------------------------

#Randomly teleport players around the big map
# CHECK LAG for using SPREADPLAYERS or just TELEPORT USING Armor stands in specific areas
