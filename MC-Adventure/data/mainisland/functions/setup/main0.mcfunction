...
# Date Edited: 2-2-20
# Desc: This will spawn in armor stands and cmd blocks and whatnot
#--------------------------------------

#Effects to blind 'leader'
...
#TELEPORT LEADER AROUND OUTSIDE OF MAINISLAND TO SPAWN IN PADS
#Summon tp from main to island armorstand
# execute if score @s time matches 290 run summon minecraft:armor_stand 190 130 65 {Tags:["greenTeamMainTp"],NoGravity:1,Invisible:1,DisabledSlots:2039583,Marker:1}
# execute if score @s time matches 290 positioned 190 130 65 run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 minecraft:lime_concrete
# execute if score @s time matches 290 positioned 190 130 65 run setblock ~ ~-1 ~ minecraft:sea_lantern

#Summon tp from main to island armorstand
execute if score @s time matches 290 run summon minecraft:armor_stand -211 166 38 {Tags:["blackTeamMainTp"],NoGravity:1,Invisible:1,DisabledSlots:2039583,Marker:1}
execute if score @s time matches 290 positioned -211 166 38 run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 minecraft:black_concrete
execute if score @s time matches 290 positioned -211 166 38 run setblock ~ ~-1 ~ minecraft:sea_lantern
...
#Summon custom villagers (Stationary)
#Plains
execute if score @s time matches 320 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] positioned ~-75 ~-45 ~60 run function mainisland:villagers/get_fred
#Jungle
execute if score @s time matches 325 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] positioned ~122 ~-33 ~52 run function mainisland:villagers/get_willy
#DarkOak
execute if score @s time matches 330 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] positioned ~-118 ~-41 ~-149 run function mainisland:villagers/get_timmy
#Ice Area
execute if score @s time matches 335 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] positioned ~23 ~-8 ~-147 run function mainisland:villagers/get_andizzy
#Behind Waterfall
execute if score @s time matches 340 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] positioned ~104 ~-32 ~-62 run function mainisland:villagers/get_lukealicious

#Outcast Villager who trades good stuff (Beat mini boss to unlock??)
#Blue Spheres
execute if score @s time matches 345 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] positioned ~20 ~-121 ~-94 run function mainisland:villagers/get_dredgen
#Green Spheres
execute if score @s time matches 350 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] positioned ~123 ~-124 ~36 run function mainisland:villagers/get_osiris
#Orange Spheres
execute if score @s time matches 355 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] positioned ~-81 ~-123 ~56 run function mainisland:villagers/get_aegeus


#Summon boss altar armor stands
execute if score @s time matches 360 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] run summon minecraft:armor_stand ~-30 ~-18 ~-163 {Tags:["iceAltar"],NoGravity:1,Invisible:1,DisabledSlots:2039583,Marker:1}
execute if score @s time matches 365 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] run summon minecraft:armor_stand ~91 ~-127 ~157 {Tags:["oceanAltar"],NoGravity:1,Invisible:1,DisabledSlots:2039583,Marker:1}
execute if score @s time matches 370 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] run summon minecraft:armor_stand ~172 ~33 ~-79 {Tags:["volcanoAltar"],NoGravity:1,Invisible:1,DisabledSlots:2039583,Marker:1}
execute if score @s time matches 375 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] run summon minecraft:armor_stand ~-144 ~-91 ~15 {Tags:["desertAltar"],NoGravity:1,Invisible:1,DisabledSlots:2039583,Marker:1}
execute if score @s time matches 380 at @e[type=minecraft:armor_stand,tag=mainCenter,limit=1] run summon minecraft:armor_stand ~-144 ~-91 ~15 {Tags:["jungleAltar"],NoGravity:1,Invisible:1,DisabledSlots:2039583,Marker:1}
...
#Back To Lobby
execute if score @s time matches 595 run effect clear @s
...
execute if score @s time matches 600 run function lobby:lobby_spawn
