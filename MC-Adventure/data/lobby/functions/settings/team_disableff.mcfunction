...
# Date Edited: 2-2-20
# Desc: This will disable friendly fire within a team and other settings
#--------------------------------------

team modify goldTeam friendlyFire false
team modify purpleTeam friendlyFire false
team modify greenTeam friendlyFire false
team modify aquaTeam friendlyFire false
team modify redTeam friendlyFire false
team modify yellowTeam friendlyFire false
team modify blueTeam friendlyFire false
team modify blackTeam friendlyFire false
