...
execute at @e[type=minecraft:armor_stand,tag=introCen,limit=1] run summon minecraft:armor_stand ~ ~1.5 ~-18 {Tags:["spectatorsIntro"],CustomNameVisible:1b,CustomName:'{"text":"Spectators","color":"dark_gray","bold":true}',NoGravity:1,Invisible:1,DisabledSlots:2039583,Marker:1}
...
execute if score crimsonTeam enabledTeams matches 1 at @e[type=minecraft:armor_stand,tag=introCen,limit=1] run summon minecraft:armor_stand ~16 ~1.5 ~-6 {Tags:["crimsonIntro"],CustomNameVisible:1b,CustomName:'{"text":"Crimson Team","color":"dark_red","bold":true}',NoGravity:1,Invisible:1,DisabledSlots:2039583,Marker:1}
execute if score cobaltTeam enabledTeams matches 1 at @e[type=minecraft:armor_stand,tag=introCen,limit=1] run summon minecraft:armor_stand ~18 ~1.5 ~ {Tags:["cobaltIntro"],CustomNameVisible:1b,CustomName:'{"text":"Cobalt Team","color":"dark_blue","bold":true}',NoGravity:1,Invisible:1,DisabledSlots:2039583,Marker:1}
