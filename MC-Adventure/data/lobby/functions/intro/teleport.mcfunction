...
execute if score introProgress intro matches 1..4 if score particles lobbySettings matches 1 at @e[type=minecraft:armor_stand,tag=intro,limit=1] run function lobby:intro/join_particles 
execute if score introProgress intro matches 1..4 at @e[type=minecraft:armor_stand,tag=intro,limit=1] as @a[team=goldTeam,tag=player,tag=!leader,distance=..2,limit=1] run function lobby:teams/gold/intro_tp
execute if score introProgress intro matches 1..4 at @e[type=minecraft:armor_stand,tag=intro,limit=1] as @a[team=purpleTeam,tag=player,tag=!leader,distance=..2,limit=1] run function lobby:teams/purple/intro_tp
execute if score introProgress intro matches 1..4 at @e[type=minecraft:armor_stand,tag=intro,limit=1] as @a[team=greenTeam,tag=player,tag=!leader,distance=..2,limit=1] run function lobby:teams/green/intro_tp
execute if score introProgress intro matches 1..4 at @e[type=minecraft:armor_stand,tag=intro,limit=1] as @a[team=aquaTeam,tag=player,tag=!leader,distance=..2,limit=1] run function lobby:teams/aqua/intro_tp
execute if score introProgress intro matches 1..4 at @e[type=minecraft:armor_stand,tag=intro,limit=1] as @a[team=redTeam,tag=player,tag=!leader,distance=..2,limit=1] run function lobby:teams/red/intro_tp
execute if score introProgress intro matches 1..4 at @e[type=minecraft:armor_stand,tag=intro,limit=1] as @a[team=yellowTeam,tag=player,tag=!leader,distance=..2,limit=1] run function lobby:teams/yellow/intro_tp
execute if score introProgress intro matches 1..4 at @e[type=minecraft:armor_stand,tag=intro,limit=1] as @a[team=blueTeam,tag=player,tag=!leader,distance=..2,limit=1] run function lobby:teams/blue/intro_tp
...
execute if score introProgress intro matches 1..4 at @e[type=minecraft:armor_stand,tag=intro,limit=1] as @a[team=,tag=player,distance=..2,limit=1] run function lobby:teams/noteam_intro_tp
