...
#Update Players
title @s subtitle ["",{"text":"To "},{"text":"Blue Team's ","color":"blue","bold":true},{"text":"Spawnpoint"}]
title @s title ["",{"text":"Teleporting ","bold":true,"color":"white"}]
function lobby:teams/blue/teamspawn
#Reset rightclick scoreboard
scoreboard players reset @s introBeginRClick
scoreboard players operation Total_Players intro -= Teammates blueTeamPlayers
