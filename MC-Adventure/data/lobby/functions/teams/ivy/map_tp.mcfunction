...
#Update Players
title @s subtitle ["",{"text":"To "},{"text":"Ivy Team's ","color":"dark_green","bold":true},{"text":"Spawnpoint"}]
title @s title ["",{"text":"Teleporting ","bold":true,"color":"white"}]
function lobby:teams/ivy/teamspawn
#Reset rightclick scoreboard
scoreboard players reset @s introBeginRClick
scoreboard players operation Total_Players intro -= Teammates iTeamPlayers
