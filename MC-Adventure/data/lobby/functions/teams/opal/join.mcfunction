...
execute if score Teammates oTeamPlayers < opalTeam maxPlayers run title @s actionbar {"text":"Select a Kit","color":"yellow","bold":true}
#Sets 'Kit' score to 0 (No Kit)
execute if score Teammates oTeamPlayers < opalTeam maxPlayers run scoreboard players enable @s chooseKit
execute if score Teammates oTeamPlayers < opalTeam maxPlayers as @s run function lobby:kits/selection_book
