...
#Update Players
title @s subtitle ["",{"text":"To "},{"text":"Opal Team's ","color":"white","bold":true},{"text":"Spawnpoint"}]
title @s title ["",{"text":"Teleporting ","bold":true,"color":"white"}]
function lobby:teams/opal/teamspawn
#Reset rightclick scoreboard
scoreboard players reset @s introBeginRClick
scoreboard players operation Total_Players intro -= Teammates oTeamPlayers
