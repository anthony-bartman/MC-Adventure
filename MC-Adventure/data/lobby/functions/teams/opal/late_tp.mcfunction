...
#Update Players
execute if score kitsEnabled lobbySettings matches 0 run title @s subtitle ["",{"text":"To "},{"text":"Opal Team's ","color":"white","bold":true},{"text":"Spawnpoint"}]
execute if score kitsEnabled lobbySettings matches 0 run title @s title ["",{"text":"Teleporting ","bold":true,"color":"white"}]
execute if score kitsEnabled lobbySettings matches 0 run title @a[team=opalTeam,tag=!newbie] title {"selector":"@s","bold":true}
execute if score kitsEnabled lobbySettings matches 0 run title @a[team=opalTeam,tag=!newbie] subtitle [{"text":"Has Joined ","color":"white","bold":true},{"text":"Opal Team","color":"white","bold":false,"italic":true}]
execute if score kitsEnabled lobbySettings matches 0 run tag @s remove newbie
execute if score kitsEnabled lobbySettings matches 0 run function lobby:teams/opal/teamspawn
...
#Update Players
execute if score kitsEnabled lobbySettings matches 1 if score @s chooseKit matches 1.. run title @s subtitle ["",{"text":"To "},{"text":"Opal Team's ","color":"white","bold":true},{"text":"Spawnpoint"}]
...
execute if score kitsEnabled lobbySettings matches 1 if score @s chooseKit matches 1.. run title @a[team=opalTeam,tag=!newbie] title {"selector":"@s","bold":true}
execute if score kitsEnabled lobbySettings matches 1 if score @s chooseKit matches 1.. run title @a[team=opalTeam,tag=!newbie] subtitle [{"text":"Has Joined ","color":"white","bold":true},{"text":"Opal Team","color":"white","bold":false,"italic":true}]
execute if score kitsEnabled lobbySettings matches 1 if score @s chooseKit matches 1.. run tag @s remove newbie
execute if score kitsEnabled lobbySettings matches 1 if score @s chooseKit matches 1.. run function lobby:teams/opal/teamspawn
