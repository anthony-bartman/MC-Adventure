...
execute if score ivyTeam enabledTeams matches 1 run tellraw @a[tag=leader] ["",{"text":"Ivy Team ","color":"dark_green","bold":true},{"text":"has a maximum of ","color":"gray","bold":false},{"score":{"name":"ivyTeam","objective":"maxPlayers"},"color":"aqua","bold":true},{"text":" Players","color":"aqua","bold":false}]
execute if score opalTeam enabledTeams matches 1 run tellraw @a[tag=leader] ["",{"text":"Opal Team ","color":"white","bold":true},{"text":"has a maximum of ","color":"gray","bold":false},{"score":{"name":"opalTeam","objective":"maxPlayers"},"color":"aqua","bold":true},{"text":" Players","color":"aqua","bold":false}]
