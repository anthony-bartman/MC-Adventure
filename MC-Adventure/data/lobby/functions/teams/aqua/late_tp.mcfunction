...
#execute if score kitsEnabled lobbySettings matches 0 if this is 1st player on team then as @s run function skyisland:setup/begin_book
...
#execute if score kitsEnabled lobbySettings matches 0 if score @s chooseKit matches 1.. if this is 1st player on team then as @s run function skyisland:setup/begin_book
