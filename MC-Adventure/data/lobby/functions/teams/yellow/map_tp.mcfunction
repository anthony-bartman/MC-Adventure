...
#Update Players
title @s subtitle ["",{"text":"To "},{"text":"Yellow Team's ","color":"yellow","bold":true},{"text":"Spawnpoint"}]
title @s title ["",{"text":"Teleporting ","bold":true,"color":"white"}]
function lobby:teams/yellow/teamspawn
#Reset rightclick scoreboard
scoreboard players reset @s introBeginRClick
scoreboard players operation Total_Players intro -= Teammates yTeamPlayers
