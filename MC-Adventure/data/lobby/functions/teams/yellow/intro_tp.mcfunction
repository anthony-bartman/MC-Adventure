...
execute if score kitsEnabled lobbySettings matches 1 run clear @s 
execute if score kitsEnabled lobbySettings matches 1 run title @s subtitle ["",{"text":"To The "},{"text":"Introduction","color":"yellow"},{"text":" Of The Map"}]
execute if score kitsEnabled lobbySettings matches 1 run title @s title ["",{"text":"Welcome ","bold":true,"color":"aqua"},{"selector":"@s[team=yellowTeam]","italic":true}]
execute if score kitsEnabled lobbySettings matches 1 run teleport @s @e[type=minecraft:armor_stand,tag=yellowIntro,limit=1]
execute if score kitsEnabled lobbySettings matches 1 run scoreboard players remove Total_Players intro 1
...
execute if score kitsEnabled lobbySettings matches 1 if score @s chooseKit matches 1.. run title @s title ["",{"text":"Welcome ","bold":true,"color":"aqua"},{"selector":"@s[team=yellowTeam]","italic":true}]
execute if score kitsEnabled lobbySettings matches 1 if score @s chooseKit matches 1.. run teleport @s @e[type=minecraft:armor_stand,tag=yellowIntro,limit=1]
