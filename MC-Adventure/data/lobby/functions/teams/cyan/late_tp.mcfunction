...
execute if score kitsEnabled lobbySettings matches 0 if score cyanMP mapProgress matches -1 as @s run function skyisland:setup/begin_book
execute if score kitsEnabled lobbySettings matches 0 if score cyanMP mapProgress matches -1 run scoreboard players enable @s help
...
execute if score kitsEnabled lobbySettings matches 1 if score @s chooseKit matches 1.. if score cyanMP mapProgress matches -1 as @s run function skyisland:setup/begin_book
execute if score kitsEnabled lobbySettings matches 1 if score @s chooseKit matches 1.. if score cyanMP mapProgress matches -1 run scoreboard players enable @s help
