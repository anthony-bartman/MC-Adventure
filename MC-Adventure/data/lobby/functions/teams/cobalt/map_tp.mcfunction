...
#Update Players
title @s subtitle ["",{"text":"To "},{"text":"Cobalt Team's ","color":"dark_blue","bold":true},{"text":"Spawnpoint"}]
title @s title ["",{"text":"Teleporting ","bold":true,"color":"white"}]
function lobby:teams/cobalt/teamspawn
#Reset rightclick scoreboard
scoreboard players reset @s introBeginRClick
scoreboard players operation Total_Players intro -= Teammates coTeamPlayers
