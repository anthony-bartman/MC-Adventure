...
#Update Players
execute if score kitsEnabled lobbySettings matches 0 run title @s subtitle ["",{"text":"To "},{"text":"Magenta Team's ","color":"light_purple","bold":true},{"text":"Spawnpoint"}]
...
#Update Players
execute if score kitsEnabled lobbySettings matches 1 if score @s chooseKit matches 1.. run title @s subtitle ["",{"text":"To "},{"text":"Magenta Team's ","color":"light_purple","bold":true},{"text":"Spawnpoint"}]
