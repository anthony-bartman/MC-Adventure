...
execute if score ivyTeam enabledTeams matches 1 if score Teammates gdTeamPlayers < ivyTeam maxPlayers at @e[tag=ivyTeam,limit=1] run particle portal ~ ~ ~ 0 .8 0 .3 2 force
execute if score opalTeam enabledTeams matches 1 if score Teammates gdTeamPlayers < opalTeam maxPlayers at @e[tag=opalTeam,limit=1] run particle portal ~ ~ ~ 0 .8 0 .3 2 force
