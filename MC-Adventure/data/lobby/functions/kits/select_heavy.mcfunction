...
title @s actionbar [{"text":"Selected: ","color":"yellow","bold":true},{"text":"Heavy Kit","color":"green","bold":true,"italic":true}]
execute as @s run function lobby:kits/get_heavy

#Sets score to 2 to say knight
scoreboard players set @s chooseKit 6
