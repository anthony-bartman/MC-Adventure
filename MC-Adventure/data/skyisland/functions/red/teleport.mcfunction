...
execute at @e[tag=redTeama] if score redTpTimer time matches 1..5 if entity @a[team=redTeam,distance=..10] run title @a[distance=..2] title {"text":" "}
execute at @e[tag=redTeama] if score redTpTimer time matches 1..5 if entity @a[team=redTeam,distance=..10] run title @a[distance=..2] subtitle {"text":" "}
execute at @e[tag=redTeama] if score redTpTimer time matches 1.. if entity @a[team=redTeam,distance=..10] run particle portal ~ ~ ~ 0 .8 0 .3 8 force
...
execute at @e[tag=redTeama] if entity @a[team=redTeam,distance=..2] if score redTpTimer time matches 90 run playsound minecraft:entity.lightning_bolt.impact master @a[distance=..5] ~ ~ ~ 100
execute at @e[tag=redTeama] if entity @a[team=redTeam,distance=..2] if score redTpTimer time matches 130 run playsound minecraft:entity.lightning_bolt.impact master @a[distance=..5] ~ ~ ~ 100
...
execute at @e[tag=redTeama] if entity @a[team=redTeam,distance=..2] if score redTpTimer time matches 330 run summon firework_rocket ~ ~1 ~ {FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:1,Colors:[I;3599359,3735491],FadeColors:[I;16777215]},{Type:2,Colors:[I;1877247,16777215],FadeColors:[I;3735551]}]}}}}
#-----
