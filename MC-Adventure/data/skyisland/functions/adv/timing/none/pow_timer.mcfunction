...
#Gets key
execute if score @s skyAltars matches 319 run function skyisland:adv/special_blocks/getsurvivalkey
execute if score @s skyAltars matches 319 run summon firework_rocket ~ ~ ~ {FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:3,Flicker:1b,Colors:[I;5898022],FadeColors:[I;16763760]},{Type:1,Flicker:1b,Colors:[I;16731635],FadeColors:[I;16777215]},{Type:2,Flicker:1b,Colors:[I;15859568],FadeColors:[I;6935295]}]}}}}

execute if score @s skyAltars matches 319 run setblock ~-5 ~2 ~ minecraft:air replace 
execute if score @s skyAltars matches 319 run setblock ~-5 ~3 ~ minecraft:sea_lantern replace
