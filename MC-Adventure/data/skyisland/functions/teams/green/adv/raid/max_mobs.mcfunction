...
scoreboard players operation greenCurrMobsLeft raidControl += @e[distance=..90,tag=green_tempraid,tag=green_raid] raidControl
scoreboard players operation greenTotalMobsLeft raidControl += @e[distance=..90,tag=green_tempraid,tag=green_raid] raidControl
