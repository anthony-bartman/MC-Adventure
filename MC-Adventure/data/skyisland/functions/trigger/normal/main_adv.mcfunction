...
#Normal
execute if score @s helpmenu_time matches 1..75 if score @s help matches 3 run function skyisland:trigger/normal/adv_help1
execute if score @s helpmenu_time matches 1..75 if score @s help matches 4 run function skyisland:trigger/normal/stuck1
execute if score @s helpmenu_time matches 1..75 if score @s help matches 5 run function oceanisland:trigger/normal/adv_help1
#Reset Menu
