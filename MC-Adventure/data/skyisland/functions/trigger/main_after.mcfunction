...
execute if score @s helpmenu_time matches 1..100 if score @s help matches 3 run function skyisland:trigger/island_settings
execute if score @s helpmenu_time matches 1..120 if score @s help matches 4 run function skyisland:trigger/stuck
execute if score @s helpmenu_time matches 1..100 if score @s help matches 5 run function mainisland:trigger/adv_help
execute if score @s helpmenu_time matches 1..120 if score @s help matches 6 run function oceanisland:trigger/adv_help
