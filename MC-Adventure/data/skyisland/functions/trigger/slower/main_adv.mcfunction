...
#Slower
execute if score @s helpmenu_time matches 1..25 if score @s help matches 3 run function skyisland:trigger/slower/adv_help2
execute if score @s helpmenu_time matches 1..25 if score @s help matches 4 run function skyisland:trigger/slower/stuck2
execute if score @s helpmenu_time matches 1..25 if score @s help matches 5 run function oceanisland:trigger/slower/adv_help2
#Reset Menu
