...
#None
execute if score @s helpmenu_time matches 1..300 if score @s help matches 3 run function skyisland:trigger/island_settings
execute if score @s helpmenu_time matches 1..300 if score @s help matches 4 run function skyisland:trigger/none/stuck0
execute if score @s helpmenu_time matches 1..300 if score @s help matches 5 run function mainisland:trigger/none/adv_help0
execute if score @s helpmenu_time matches 1..300 if score @s help matches 6 run function oceanisland:trigger/none/adv_help0
#Reset Players Score
